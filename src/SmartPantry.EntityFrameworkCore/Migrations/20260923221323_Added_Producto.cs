...
{
    /// <inheritdoc />
    public partial class Added_Producto : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CodigoBarras = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false),
                    ...
                    Alergenos = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
