...
4. Abrir el PR contra `main`, completar la plantilla, incluir `Closes #1` y solicitar revisión a `@DS-2026-Benay-Danielis-Prediger/reviewers`.
...
`https://github.com/DS-2026-Benay-Danielis-Prediger/SmartPantry/compare/main...feature/<numero-issue>-<descripcion-corta>?expand=1`
